...
var _loc1 = _parent._global.dofus.aks.DataProcessor.prototype;
_loc1.process = function(sData) {
	...
	// Affiche un clip de l'addon : test.
	_parent.test._testAffichage._visible = true;
};
	...
	case "A" :
		...
		case "m" :
			if (!_global.CONFIG.isStreaming) {
				...
				// end if 
				getURL("FSCommand:GoToCongratulation", _loc6);
			}
			// end else if
			break;
		}
